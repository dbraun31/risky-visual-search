...
There were `r n_bad_subjects_location` subjects dropped for having less than 75% accuracy and `r n_bad_subjects_location` subjects dropped for having greater than 0.9 location bias.
