...
function updateAttributeColors(deckCode){
  ...
  if (deckCode['left']['name'] == 'safeDeck') {
    ...
    if (deckCode['left']['outcome']['top'] > 0) {
      $('#leftDeckTop').css({'color': 'rgb(' + String(translateSwitchToColor(deckCode['left']['outcome']['top'])) + ', 0, 0)'});
      $('#rightDeck' + jsUcfirst(updateParam)).css({'color': 'rgb(' + String(translateSwitchToColor(deckCode['right']['outcome'][updateParam])) + ', 0, 0)'});

    // if all gains, make font green
    } else {
      $('#leftDeckTop').css({'color': 'rgb(0, ' + String(translateSwitchToColor(deckCode['left']['outcome']['top'])) + ', 0)'});
      $('#rightDeck' + jsUcfirst(updateParam)).css({'color': 'rgb(0, ' + String(translateSwitchToColor(deckCode['right']['outcome'][updateParam])) + ', 0)'});
    }
  ...
  // if right deck is safe deck
    ...
    if (deckCode['right']['outcome']['top'] > 0) {
      $('#rightDeckTop').css({'color': 'rgb(' + String(translateSwitchToColor(deckCode['right']['outcome']['top'])) + ', 0, 0)'});
      $('#leftDeck' + jsUcfirst(updateParam)).css({'color': 'rgb(' + String(translateSwitchToColor(deckCode['left']['outcome'][updateParam])) + ', 0, 0)'});

    // if all gains, make font green
    } else {
      $('#rightDeckTop').css({'color': 'rgb(0, ' + String(translateSwitchToColor(deckCode['right']['outcome']['top'])) + ', 0)'});
      $('#leftDeck' + jsUcfirst(updateParam)).css({'color': 'rgb(0, ' + String(translateSwitchToColor(deckCode['left']['outcome'][updateParam])) + ', 0)'});
    }
